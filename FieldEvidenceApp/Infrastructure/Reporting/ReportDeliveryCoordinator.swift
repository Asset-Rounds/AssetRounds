...
enum C33TemporalEvidenceConformance_FieldEvidenceApp_Infrastructure_Reporting_ReportDeliveryCoordinator_swift {
...
enum C47ActivityContractConformance_FieldEvidenceApp_Infrastructure_Reporting_ReportDeliveryCoordinator_swift {
    static let integrationRole = "NO_APPROVAL_DELIVERY_CLAIM"
...
enum C52ServiceRequestBoundary_FieldEvidenceApp_Infrastructure_Reporting_ReportDeliveryCoordinator_swift {
