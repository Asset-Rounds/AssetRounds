...
enum PersistentSchemaReleaseV1: String, Codable, Equatable, Sendable {
    ...
    var migrationStage: PersistentSchemaMigrationStageV1 {
        ...
        case .v5, .v6, .v7, .v8, .v9, .v10, .v11, .v12, .v13, .v14, .v15, .v16: return .custom
        }
    }
}
...
enum PersistentSchemaReleaseRegistryV1 {
    ...
    static let releases: [PersistentSchemaReleaseV1] = [.v1,.v2,.v3,.v4,.v5,.v6,.v7,.v8,.v9,.v10,.v11,.v12,.v13,.v14,.v15,.v16]

    static let activeVersionIdentifier=PersistentSchemaV16.versionIdentifier;static let activeCompatibilityID=v16CompatibilityID
    ...
    static var activeMigrationPlan: any SchemaMigrationPlan.Type {
        PersistentSchemaMigrationPlanV15.self
    }
    ...
    static func validate(
        ...
        guard activeRelease == .v16,activeVersionIdentifier==candidate[15].versionIdentifier,activeCompatibilityID==candidate[15].compatibilityID,
              ...
              PersistentSchemaMigrationPlanV15.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV15.schemas[0])==ObjectIdentifier(PersistentSchemaV15.self),ObjectIdentifier(PersistentSchemaMigrationPlanV15.schemas[1])==ObjectIdentifier(PersistentSchemaV16.self),PersistentSchemaMigrationPlanV15.stages.count==1 else {
            throw PersistentSchemaReleaseRegistryErrorV1.invalidActiveRelease
        }
    }
    ...
    static func activeSchema() throws -> Schema {
        try validate()
        return Schema(PersistentSchemaV16.models,version:PersistentSchemaV16.versionIdentifier)
    }
}
