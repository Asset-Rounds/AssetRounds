...
enum PersistentSchemaReleaseV1: String, Codable, Equatable, Sendable {
    ...
    var migrationStage: PersistentSchemaMigrationStageV1 {
        ...
        case .v5, .v6, .v7, .v8, .v9, .v10, .v11, .v12, .v13, .v14, .v15: return .custom
        }
    }
}
...
enum PersistentSchemaReleaseRegistryV1 {
    ...
    static let releases: [PersistentSchemaReleaseV1] = [.v1,.v2,.v3,.v4,.v5,.v6,.v7,.v8,.v9,.v10,.v11,.v12,.v13,.v14,.v15]

    static let activeVersionIdentifier=PersistentSchemaV15.versionIdentifier;static let activeCompatibilityID=v15CompatibilityID
    ...
    static var activeMigrationPlan: any SchemaMigrationPlan.Type {
        PersistentSchemaMigrationPlanV14.self
    }
    ...
    static func validate(
        ...
        guard activeRelease == .v15,activeVersionIdentifier==candidate[14].versionIdentifier,activeCompatibilityID==candidate[14].compatibilityID,
              ...
              PersistentSchemaMigrationPlanV14.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV14.schemas[0])==ObjectIdentifier(PersistentSchemaV14.self),ObjectIdentifier(PersistentSchemaMigrationPlanV14.schemas[1])==ObjectIdentifier(PersistentSchemaV15.self),PersistentSchemaMigrationPlanV14.stages.count==1 else {
            throw PersistentSchemaReleaseRegistryErrorV1.invalidActiveRelease
        }
    }
    ...
    static func activeSchema() throws -> Schema {
        try validate()
        return Schema(PersistentSchemaV15.models,version:PersistentSchemaV15.versionIdentifier)
    }
}
