...
enum PersistentSchemaV38:VersionedSchema{static let versionIdentifier=Schema.Version(38,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV37.models+[ExceptionCalendarReleaseRow.self,ScheduleOverrideEventRow.self]}}
enum PersistentSchemaV39:VersionedSchema{static let versionIdentifier=Schema.Version(39,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV38.models+[ServiceRequestRecordRow.self,ServiceRequestDispositionEventRow.self,ServiceRequestWorkLinkEventRow.self]}}
enum PersistentSchemaV40:VersionedSchema{static let versionIdentifier=Schema.Version(40,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV39.models+[AssetServiceIncidentRow.self,ServiceImpactSegmentRow.self,ServiceCauseAssertionRow.self,ServiceRemedyAssertionRow.self,ServiceRepairIntervalRow.self,ServiceRestorationAssertionRow.self,QualifiedServiceExposureRow.self]}}
enum PersistentSchemaV41:VersionedSchema{static let versionIdentifier=Schema.Version(41,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV40.models+[LocalPartDefinitionRowV1.self,StockStorageLocationRowV1.self,StockMovementEventRowV1.self,StockUseReceiptRowV1.self,StockUseReversalReceiptRowV1.self,StockReturnReceiptRowV1.self,AbandonUnverifiedStockRowV1.self]}}
enum PersistentSchemaV42:VersionedSchema{static let versionIdentifier=Schema.Version(42,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV41.models+[MyDayPlanRowV1.self,MyDayCarryoverReceiptRowV1.self]}}
enum PersistentSchemaV43:VersionedSchema{static let versionIdentifier=Schema.Version(43,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV42.models+[EvidenceAssociationEventRowV1.self,EvidenceSequenceRevisionRowV1.self]}}
enum PersistentSchemaV44:VersionedSchema{static let versionIdentifier=Schema.Version(44,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV43.models+[ShopReportProfileRowV1.self]}}
enum PersistentSchemaV45:VersionedSchema{static let versionIdentifier=Schema.Version(45,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV44.models+[RoundSessionRevisionRowV1.self]}}
enum PersistentSchemaV46:VersionedSchema{static let versionIdentifier=Schema.Version(46,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV45.models+[ImportMappingProfileRowV1.self,BulkSessionRowV1.self,BulkCommitReceiptRowV1.self]}}
/// C10 appends revision-bound assessment, rule, and waiver facts without
/// rewriting historic evidence or prior quality decisions.
enum PersistentSchemaV47:VersionedSchema{static let versionIdentifier=Schema.Version(47,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV46.models+[EvidenceQualityRuleSetRowV1.self,EvidenceQualityAssessmentRowV1.self,EvidenceQualityWaiverRowV1.self,EvidenceQualityMutationReceiptRowV1.self]}}
/// C11 appends offline inbox, promotion, and snippet history without allowing
/// unpromoted captures to become inspection or report facts.
enum PersistentSchemaV48:VersionedSchema{static let versionIdentifier=Schema.Version(48,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV47.models+[CaptureInboxItemRowV1.self,CapturePromotionRowV1.self,SnippetRowV1.self,SnippetInsertionHistoryRowV1.self,FastSurveyInboxMutationReceiptRowV1.self]}}
enum PersistentSchemaV49:VersionedSchema{static let versionIdentifier=Schema.Version(49,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV48.models+[ReinspectionPlanRowV1.self,UnchangedAttestationRowV1.self,ExceptionQueueAcknowledgementRowV1.self,ReinspectionExceptionMutationReceiptRowV1.self]}}
/// C13 persists only immutable alias and consolidation history plus its typed
/// receipt. Resolution plans/previews remain derived and mutation-free.
enum PersistentSchemaV50:VersionedSchema{static let versionIdentifier=Schema.Version(50,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV49.models+[EntityAliasLinkRowV1.self,EntityConsolidationReceiptRowV1.self,EntityIdentityResolutionMutationReceiptRowV1.self]}}
enum PersistentSchemaV51:VersionedSchema{static let versionIdentifier=Schema.Version(51,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV50.models+[PracticeWorkspaceProvenanceRowV1.self]}}
/// C17 adds one append-only day-inventory workflow aggregate. Safety,
/// conditions, and night planning are embedded canonical fields, not models.
enum PersistentSchemaV52:VersionedSchema{static let versionIdentifier=Schema.Version(52,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV51.models+[LightingDayInventoryWorkflowRowV1.self]}}
enum PersistentSchemaV53:VersionedSchema{static let versionIdentifier=Schema.Version(53,0,0);static var models:[any PersistentModel.Type]{PersistentSchemaV52.models+[LightingNightWorkflowRowV1.self]}}

enum EvidenceQualitySchemaMigrationBoundaryV1 {
    static let downgradeDisposition = "PRE_ACTIVATION_ONLY_FORWARD_FIX_AFTER_ACTIVATION"

    static func validate() -> Bool {
        EvidenceQualitySchemaV1.schemaVersion == 47
            && EvidenceQualitySchemaV1.predecessorSchemaVersion == 46
            && EvidenceQualitySchemaV1.durableModelCount == 4
            && !EvidenceQualitySchemaV1.createsSecondStore
            && PersistentSchemaV47.models.count == PersistentSchemaV46.models.count + 4
            && PersistentSchemaV47.models.suffix(4).map { ObjectIdentifier($0) }
                == EvidenceQualitySchemaV1.modelTypes.map { ObjectIdentifier($0) }
    }
}

enum FastSurveyInboxSchemaMigrationBoundaryV1 {
    static let downgradeDisposition = "PRE_ACTIVATION_ONLY_FORWARD_FIX_AFTER_ACTIVATION"

    static func validate() -> Bool {
        FastSurveyInboxSchemaV1.schemaVersion == 48
            && FastSurveyInboxSchemaV1.predecessorSchemaVersion == 47
            && FastSurveyInboxSchemaV1.durableModelCount == 5
            && !FastSurveyInboxLifecycleV1.createsSecondStore
            && PersistentSchemaV48.models.count == PersistentSchemaV47.models.count + 5
            && PersistentSchemaV48.models.suffix(5).map { ObjectIdentifier($0) }
                == FastSurveyInboxSchemaV1.modelTypes.map { ObjectIdentifier($0) }
    }
}
...
enum PersistentSchemaReleaseV1: String, Codable, Equatable, Sendable {
    ...
    var compatibilityID: String {
        ...
        case .v38:return "ADVANCED_SCHEDULE_EXCEPTION_V1"
        case .v39:return "PORTABLE_SERVICE_REQUEST_V1"
        case .v40:return "ASSET_SERVICE_RELIABILITY_V1"
        case .v41:return "LOCAL_PART_STOCK_V1"
        case .v42:return "MY_DAY_PLAN_V1"
        case .v43:return "EVIDENCE_CURATION_V1"
        case .v44:return "SHOP_REPORT_PROFILE_V1"
        case .v45:return "ROUND_SESSION_V1"
        case .v46:return "IMPORT_BULK_PROFILE_SESSION_RECEIPT_V1"
        case .v47:return "EVIDENCE_QUALITY_SCHEMA_V1"
        case .v48:return "FAST_SURVEY_INBOX_SCHEMA_V1"
        case .v49:return "REINSPECTION_EXCEPTION_QUEUE_SCHEMA_V1"
        case .v50:return "ENTITY_IDENTITY_RESOLUTION_V1"
        case .v51:return "WORKSPACE_EXPERIENCE_PRACTICE_PROVENANCE_V1"
        case .v52:return "LIGHTING_DAY_INVENTORY_WORKFLOW_V1"
        case .v53:return "LIGHTING_NIGHT_WORKFLOW_V1"
        }
    }
    ...
    var versionIdentifier: Schema.Version {
        ...
        case .v38:return PersistentSchemaV38.versionIdentifier
        case .v39:return PersistentSchemaV39.versionIdentifier
        case .v40:return PersistentSchemaV40.versionIdentifier
        case .v41:return PersistentSchemaV41.versionIdentifier
        case .v42:return PersistentSchemaV42.versionIdentifier
        case .v43:return PersistentSchemaV43.versionIdentifier
        case .v44:return PersistentSchemaV44.versionIdentifier
        case .v45:return PersistentSchemaV45.versionIdentifier
        case .v46:return PersistentSchemaV46.versionIdentifier
        case .v47:return PersistentSchemaV47.versionIdentifier
        case .v48:return PersistentSchemaV48.versionIdentifier
        case .v49:return PersistentSchemaV49.versionIdentifier
        case .v50:return PersistentSchemaV50.versionIdentifier
        case .v51:return PersistentSchemaV51.versionIdentifier
        case .v52:return PersistentSchemaV52.versionIdentifier
        case .v53:return PersistentSchemaV53.versionIdentifier
        }
    }
    ...
    var predecessorVersionIdentifier: Schema.Version? {
        ...
        case .v38:return PersistentSchemaV37.versionIdentifier
        case .v39:return PersistentSchemaV38.versionIdentifier
        case .v40:return PersistentSchemaV39.versionIdentifier
        case .v41:return PersistentSchemaV40.versionIdentifier
        case .v42:return PersistentSchemaV41.versionIdentifier
        case .v43:return PersistentSchemaV42.versionIdentifier
        case .v44:return PersistentSchemaV43.versionIdentifier
        case .v45:return PersistentSchemaV44.versionIdentifier
        case .v46:return PersistentSchemaV45.versionIdentifier
        case .v47:return PersistentSchemaV46.versionIdentifier
        case .v48:return PersistentSchemaV47.versionIdentifier
        case .v49:return PersistentSchemaV48.versionIdentifier
        case .v50:return PersistentSchemaV49.versionIdentifier
        case .v51:return PersistentSchemaV50.versionIdentifier
        case .v52:return PersistentSchemaV51.versionIdentifier
    ...
    var models: [any PersistentModel.Type] {
        ...
        case .v38:return PersistentSchemaV38.models
        case .v39:return PersistentSchemaV39.models
        case .v40:return PersistentSchemaV40.models
        case .v41:return PersistentSchemaV41.models
        case .v42:return PersistentSchemaV42.models
        case .v43:return PersistentSchemaV43.models
        case .v44:return PersistentSchemaV44.models
        case .v45:return PersistentSchemaV45.models
        case .v46:return PersistentSchemaV46.models
        case .v47:return PersistentSchemaV47.models
        case .v48:return PersistentSchemaV48.models
        case .v49:return PersistentSchemaV49.models
        case .v50:return PersistentSchemaV50.models
        case .v51:return PersistentSchemaV51.models
        case .v52:return PersistentSchemaV52.models
        case .v53:return PersistentSchemaV53.models
        }
    }
    ...
    var migrationStage: PersistentSchemaMigrationStageV1 {
        ...
        case .v5, .v6, .v7, .v8, .v9, .v10, .v11, .v12, .v13, .v14, .v15, .v16, .v17, .v18, .v19, .v20, .v21, .v22, .v23, .v24, .v25, .v26, .v27, .v28, .v29, .v30, .v31, .v32, .v33, .v34, .v35, .v36, .v37, .v38, .v39, .v40, .v41, .v42, .v43, .v44, .v45, .v46, .v47, .v48, .v49, .v50, .v51, .v52, .v53: return .custom
        }
    }
}
...
enum PersistentSchemaMigrationPlanV37:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV37.self,PersistentSchemaV38.self]};static let migrateV37ToV38=MigrationStage.custom(fromVersion:PersistentSchemaV37.self,toVersion:PersistentSchemaV38.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV37ToV38]}}
enum PersistentSchemaMigrationPlanV38:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV38.self,PersistentSchemaV39.self]};static let migrateV38ToV39=MigrationStage.custom(fromVersion:PersistentSchemaV38.self,toVersion:PersistentSchemaV39.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV38ToV39]}}
enum PersistentSchemaMigrationPlanV39:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV39.self,PersistentSchemaV40.self]};static let migrateV39ToV40=MigrationStage.custom(fromVersion:PersistentSchemaV39.self,toVersion:PersistentSchemaV40.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV39ToV40]}}
enum PersistentSchemaMigrationPlanV40:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV40.self,PersistentSchemaV41.self]};static let migrateV40ToV41=MigrationStage.custom(fromVersion:PersistentSchemaV40.self,toVersion:PersistentSchemaV41.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV40ToV41]}}
enum PersistentSchemaMigrationPlanV41:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV41.self,PersistentSchemaV42.self]};static let migrateV41ToV42=MigrationStage.custom(fromVersion:PersistentSchemaV41.self,toVersion:PersistentSchemaV42.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV41ToV42]}}
enum PersistentSchemaMigrationPlanV42:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV42.self,PersistentSchemaV43.self]};static let migrateV42ToV43=MigrationStage.custom(fromVersion:PersistentSchemaV42.self,toVersion:PersistentSchemaV43.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV42ToV43]}}
enum PersistentSchemaMigrationPlanV43:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV43.self,PersistentSchemaV44.self]};static let migrateV43ToV44=MigrationStage.custom(fromVersion:PersistentSchemaV43.self,toVersion:PersistentSchemaV44.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV43ToV44]}}
enum PersistentSchemaMigrationPlanV44:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV44.self,PersistentSchemaV45.self]};static let migrateV44ToV45=MigrationStage.custom(fromVersion:PersistentSchemaV44.self,toVersion:PersistentSchemaV45.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV44ToV45]}}
enum PersistentSchemaMigrationPlanV45:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV45.self,PersistentSchemaV46.self]};static let migrateV45ToV46=MigrationStage.custom(fromVersion:PersistentSchemaV45.self,toVersion:PersistentSchemaV46.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV45ToV46]}}
enum PersistentSchemaMigrationPlanV46:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV46.self,PersistentSchemaV47.self]};static let migrateV46ToV47=MigrationStage.custom(fromVersion:PersistentSchemaV46.self,toVersion:PersistentSchemaV47.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV46ToV47]}}
enum PersistentSchemaMigrationPlanV47:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV47.self,PersistentSchemaV48.self]};static let migrateV47ToV48=MigrationStage.custom(fromVersion:PersistentSchemaV47.self,toVersion:PersistentSchemaV48.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV47ToV48]}}
enum PersistentSchemaMigrationPlanV48:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV48.self,PersistentSchemaV49.self]};static let migrateV48ToV49=MigrationStage.custom(fromVersion:PersistentSchemaV48.self,toVersion:PersistentSchemaV49.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV48ToV49]}}
enum PersistentSchemaMigrationPlanV49:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV49.self,PersistentSchemaV50.self]};static let migrateV49ToV50=MigrationStage.custom(fromVersion:PersistentSchemaV49.self,toVersion:PersistentSchemaV50.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV49ToV50]}}
enum PersistentSchemaMigrationPlanV50:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV50.self,PersistentSchemaV51.self]};static let migrateV50ToV51=MigrationStage.custom(fromVersion:PersistentSchemaV50.self,toVersion:PersistentSchemaV51.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV50ToV51]}}
enum PersistentSchemaMigrationPlanV51:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV51.self,PersistentSchemaV52.self]};static let migrateV51ToV52=MigrationStage.custom(fromVersion:PersistentSchemaV51.self,toVersion:PersistentSchemaV52.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV51ToV52]}}
enum PersistentSchemaMigrationPlanV52:SchemaMigrationPlan{static var schemas:[any VersionedSchema.Type]{[PersistentSchemaV52.self,PersistentSchemaV53.self]};static let migrateV52ToV53=MigrationStage.custom(fromVersion:PersistentSchemaV52.self,toVersion:PersistentSchemaV53.self,willMigrate:nil,didMigrate:{_ in});static var stages:[MigrationStage]{[migrateV52ToV53]}}

enum WorkspaceExperienceSchemaMigrationBoundaryV1 {
    static let downgradeDisposition = "PRE_ACTIVATION_ONLY_FORWARD_FIX_AFTER_ACTIVATION"
    static func validate() -> Bool {
        WorkspaceExperiencePersistenceBoundaryV1.predecessorPersistentSchemaVersion == 50
            && WorkspaceExperiencePersistenceBoundaryV1.targetPersistentSchemaVersion == 51
            && PersistentSchemaV51.models.count == 166
            && PersistentSchemaV51.models.count == PersistentSchemaV50.models.count + 1
            && ObjectIdentifier(PersistentSchemaV51.models.last!) == ObjectIdentifier(PracticeWorkspaceProvenanceRowV1.self)
            ...
            && !WorkspaceExperiencePersistenceBoundaryV1.secondDurableInstallReceiptRow
    }
}

enum LightingDayInventorySchemaMigrationBoundaryV1 {
    static let downgradeDisposition = "PRE_ACTIVATION_ONLY_FORWARD_FIX_AFTER_ACTIVATION"
    static func validate() -> Bool {
        LightingDayInventoryPersistenceEnrollmentV1.persistentSchemaVersion == 52
            ...
            && PersistentSchemaV52.models.count == PersistentSchemaV51.models.count + 1
            && ObjectIdentifier(PersistentSchemaV52.models.last!) == ObjectIdentifier(LightingDayInventoryWorkflowRowV1.self)
    }
}
enum LightingNightWorkflowSchemaMigrationBoundaryV1 {
    static let downgradeDisposition = "PRE_ACTIVATION_ONLY_FORWARD_FIX_AFTER_ACTIVATION"
    static func validate() -> Bool {
        LightingNightWorkflowPersistenceEnrollmentV1.persistentSchemaVersion == 53
            ...
            && PersistentSchemaV53.models.count == 168
            && PersistentSchemaV53.models.count == PersistentSchemaV52.models.count + 1
            && ObjectIdentifier(PersistentSchemaV53.models.last!) == ObjectIdentifier(LightingNightWorkflowRowV1.self)
    }
}

enum C08ImportBulkPersistenceBoundaryV1 {
    ...
    static func validate() -> Bool {
        persistentSchemaVersion == 46
            && durableKinds == [
                "ImportMappingProfileRowV1",
                "BulkSessionRowV1",
                "BulkCommitReceiptRowV1"
            ]
            && PersistentSchemaV46.models.count == PersistentSchemaV45.models.count + 3
    }
}

enum ReinspectionExceptionSchemaMigrationBoundaryV1 {
    static let persistentSchemaVersion = 49
    static let predecessorSchemaVersion = 48
    static let durableModelCount = 4

    static func validate() -> Bool {
        persistentSchemaVersion == ReinspectionAndExceptionSchemaV1.schemaVersion
            && predecessorSchemaVersion == ReinspectionAndExceptionSchemaV1.predecessorSchemaVersion
            && durableModelCount == ReinspectionAndExceptionSchemaV1.durableModelCount
            && PersistentSchemaV49.models.count == 162
            && PersistentSchemaV49.models.count == PersistentSchemaV48.models.count + durableModelCount
            && PersistentSchemaV49.models.suffix(durableModelCount).map { ObjectIdentifier($0) }
                == ReinspectionAndExceptionSchemaV1.modelTypes.map { ObjectIdentifier($0) }
    }
}

enum EntityIdentityResolutionSchemaMigrationBoundaryV1 {
    static let persistentSchemaVersion = 50
    static let predecessorSchemaVersion = 49
    static let durableModelCount = 3
    static let downgradeDisposition = "PRE_ACTIVATION_ONLY_FORWARD_FIX_AFTER_ACTIVATION"

    static func validate() -> Bool {
        persistentSchemaVersion == 50
            && predecessorSchemaVersion == 49
            && durableModelCount == 3
            && !EntityIdentityResolutionLifecycleV1.plansAndPreviewsArePersistent
            && !EntityIdentityResolutionLifecycleV1.automaticMutation
            && !EntityIdentityResolutionLifecycleV1.createsSecondStore
...
enum PersistentSchemaReleaseRegistryV1 {
    ...
    static let v38CompatibilityID=PersistentSchemaReleaseV1.v38.compatibilityID
    static let v39CompatibilityID=PersistentSchemaReleaseV1.v39.compatibilityID
    static let v40CompatibilityID=PersistentSchemaReleaseV1.v40.compatibilityID
    static let v41CompatibilityID=PersistentSchemaReleaseV1.v41.compatibilityID
    static let v42CompatibilityID=PersistentSchemaReleaseV1.v42.compatibilityID
    static let v43CompatibilityID=PersistentSchemaReleaseV1.v43.compatibilityID
    static let v44CompatibilityID=PersistentSchemaReleaseV1.v44.compatibilityID
    static let v45CompatibilityID=PersistentSchemaReleaseV1.v45.compatibilityID
    static let v46CompatibilityID=PersistentSchemaReleaseV1.v46.compatibilityID
    static let v47CompatibilityID=PersistentSchemaReleaseV1.v47.compatibilityID
    static let v48CompatibilityID=PersistentSchemaReleaseV1.v48.compatibilityID
    static let v49CompatibilityID=PersistentSchemaReleaseV1.v49.compatibilityID
    static let v50CompatibilityID=PersistentSchemaReleaseV1.v50.compatibilityID
    static let v51CompatibilityID=PersistentSchemaReleaseV1.v51.compatibilityID
    static let v52CompatibilityID=PersistentSchemaReleaseV1.v52.compatibilityID
    static let v2MarkerIDString = "00000000-0000-0000-0000-000000000002"
    static let v2MarkerID = UUID(uuidString: v2MarkerIDString)!

    static let releases: [PersistentSchemaReleaseV1] = [.v1,.v2,.v3,.v4,.v5,.v6,.v7,.v8,.v9,.v10,.v11,.v12,.v13,.v14,.v15,.v16,.v17,.v18,.v19,.v20,.v21,.v22,.v23,.v24,.v25,.v26,.v27,.v28,.v29,.v30,.v31,.v32,.v33,.v34,.v35,.v36,.v37,.v38,.v39,.v40,.v41,.v42,.v43,.v44,.v45,.v46,.v47,.v48,.v49,.v50,.v51,.v52,.v53]

    static let v53CompatibilityID=PersistentSchemaReleaseV1.v53.compatibilityID
    static let activeVersionIdentifier=PersistentSchemaV53.versionIdentifier;static let activeCompatibilityID=v53CompatibilityID
    ...
    static var activeMigrationPlan: any SchemaMigrationPlan.Type {
        PersistentSchemaMigrationPlanV52.self
    }

    static func validate() throws {
        guard C50IncumbentFileExchangePersistenceBoundaryV1.validate(),
              C51ScheduleExceptionMigrationBoundaryV1.validate(),
              C05EvidenceCurationMigrationBoundaryV1.validate(),
              C04ShopReportProfileMigrationBoundaryV1.validate(),
              C05RoundSessionMigrationBoundaryV1.validate(),
              C08ImportBulkPersistenceBoundaryV1.validate(),
              EvidenceQualitySchemaMigrationBoundaryV1.validate(),
              FastSurveyInboxSchemaMigrationBoundaryV1.validate(),
              ReinspectionExceptionSchemaMigrationBoundaryV1.validate(),
              EntityIdentityResolutionSchemaMigrationBoundaryV1.validate(),
              WorkspaceExperienceSchemaMigrationBoundaryV1.validate(),
              LightingDayInventorySchemaMigrationBoundaryV1.validate(),
              LightingNightWorkflowSchemaMigrationBoundaryV1.validate() else {
            throw PersistentSchemaReleaseRegistryErrorV1.invalidActiveRelease
        }
    ...
    static func validate(
        ...
        let expectedV38ModelIDs=PersistentSchemaV38.models.map{ObjectIdentifier($0)}
        guard candidate[37] == .v38,candidate[37].versionIdentifier==PersistentSchemaV38.versionIdentifier,candidate[37].compatibilityID==v38CompatibilityID,candidate[37].predecessorVersionIdentifier==PersistentSchemaV37.versionIdentifier,candidate[37].models.count==123,candidate[37].models.map({ObjectIdentifier($0)})==expectedV38ModelIDs,Array(expectedV38ModelIDs.dropLast(2))==expectedV37ModelIDs,candidate[37].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV39ModelIDs=PersistentSchemaV39.models.map{ObjectIdentifier($0)}
        guard candidate[38] == .v39,candidate[38].versionIdentifier==PersistentSchemaV39.versionIdentifier,candidate[38].compatibilityID==v39CompatibilityID,candidate[38].predecessorVersionIdentifier==PersistentSchemaV38.versionIdentifier,candidate[38].models.count==126,candidate[38].models.map({ObjectIdentifier($0)})==expectedV39ModelIDs,Array(expectedV39ModelIDs.dropLast(3))==expectedV38ModelIDs,candidate[38].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV40ModelIDs=PersistentSchemaV40.models.map{ObjectIdentifier($0)}
        guard candidate[39] == .v40,candidate[39].versionIdentifier==PersistentSchemaV40.versionIdentifier,candidate[39].compatibilityID==v40CompatibilityID,candidate[39].predecessorVersionIdentifier==PersistentSchemaV39.versionIdentifier,candidate[39].models.count==133,candidate[39].models.map({ObjectIdentifier($0)})==expectedV40ModelIDs,Array(expectedV40ModelIDs.dropLast(7))==expectedV39ModelIDs,candidate[39].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV41ModelIDs=PersistentSchemaV41.models.map{ObjectIdentifier($0)}
        guard candidate[40] == .v41,candidate[40].versionIdentifier==PersistentSchemaV41.versionIdentifier,candidate[40].compatibilityID==v41CompatibilityID,candidate[40].predecessorVersionIdentifier==PersistentSchemaV40.versionIdentifier,candidate[40].models.count==140,candidate[40].models.map({ObjectIdentifier($0)})==expectedV41ModelIDs,Array(expectedV41ModelIDs.dropLast(7))==expectedV40ModelIDs,candidate[40].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV42ModelIDs=PersistentSchemaV42.models.map{ObjectIdentifier($0)}
        guard candidate[41] == .v42,candidate[41].versionIdentifier==PersistentSchemaV42.versionIdentifier,candidate[41].compatibilityID==v42CompatibilityID,candidate[41].predecessorVersionIdentifier==PersistentSchemaV41.versionIdentifier,candidate[41].models.count==142,candidate[41].models.map({ObjectIdentifier($0)})==expectedV42ModelIDs,Array(expectedV42ModelIDs.dropLast(2))==expectedV41ModelIDs,candidate[41].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV43ModelIDs=PersistentSchemaV43.models.map{ObjectIdentifier($0)}
        guard candidate[42] == .v43,candidate[42].versionIdentifier==PersistentSchemaV43.versionIdentifier,candidate[42].compatibilityID==v43CompatibilityID,candidate[42].predecessorVersionIdentifier==PersistentSchemaV42.versionIdentifier,candidate[42].models.count==144,candidate[42].models.map({ObjectIdentifier($0)})==expectedV43ModelIDs,Array(expectedV43ModelIDs.dropLast(2))==expectedV42ModelIDs,candidate[42].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV44ModelIDs=PersistentSchemaV44.models.map{ObjectIdentifier($0)}
        guard candidate[43] == .v44,candidate[43].versionIdentifier==PersistentSchemaV44.versionIdentifier,candidate[43].compatibilityID==v44CompatibilityID,candidate[43].predecessorVersionIdentifier==PersistentSchemaV43.versionIdentifier,candidate[43].models.count==145,candidate[43].models.map({ObjectIdentifier($0)})==expectedV44ModelIDs,Array(expectedV44ModelIDs.dropLast())==expectedV43ModelIDs,candidate[43].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV45ModelIDs=PersistentSchemaV45.models.map{ObjectIdentifier($0)}
        guard candidate[44] == .v45,candidate[44].versionIdentifier==PersistentSchemaV45.versionIdentifier,candidate[44].compatibilityID==v45CompatibilityID,candidate[44].predecessorVersionIdentifier==PersistentSchemaV44.versionIdentifier,candidate[44].models.count==146,candidate[44].models.map({ObjectIdentifier($0)})==expectedV45ModelIDs,Array(expectedV45ModelIDs.dropLast())==expectedV44ModelIDs,candidate[44].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}

        let expectedV46ModelIDs=PersistentSchemaV46.models.map{ObjectIdentifier($0)}
        guard candidate[45] == .v46,candidate[45].versionIdentifier==PersistentSchemaV46.versionIdentifier,candidate[45].compatibilityID==v46CompatibilityID,candidate[45].predecessorVersionIdentifier==PersistentSchemaV45.versionIdentifier,candidate[45].models.count==149,candidate[45].models.map({ObjectIdentifier($0)})==expectedV46ModelIDs,Array(expectedV46ModelIDs.dropLast(3))==expectedV45ModelIDs,candidate[45].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV47ModelIDs=PersistentSchemaV47.models.map{ObjectIdentifier($0)}
        guard candidate[46] == .v47,candidate[46].versionIdentifier==PersistentSchemaV47.versionIdentifier,candidate[46].compatibilityID==v47CompatibilityID,candidate[46].predecessorVersionIdentifier==PersistentSchemaV46.versionIdentifier,candidate[46].models.count==153,candidate[46].models.map({ObjectIdentifier($0)})==expectedV47ModelIDs,Array(expectedV47ModelIDs.dropLast(4))==expectedV46ModelIDs,candidate[46].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV48ModelIDs=PersistentSchemaV48.models.map{ObjectIdentifier($0)}
        guard candidate[47] == .v48,candidate[47].versionIdentifier==PersistentSchemaV48.versionIdentifier,candidate[47].compatibilityID==v48CompatibilityID,candidate[47].predecessorVersionIdentifier==PersistentSchemaV47.versionIdentifier,candidate[47].models.count==158,candidate[47].models.map({ObjectIdentifier($0)})==expectedV48ModelIDs,Array(expectedV48ModelIDs.dropLast(5))==expectedV47ModelIDs,candidate[47].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV49ModelIDs=PersistentSchemaV49.models.map{ObjectIdentifier($0)}
        guard candidate[48] == .v49,candidate[48].versionIdentifier==PersistentSchemaV49.versionIdentifier,candidate[48].compatibilityID==v49CompatibilityID,candidate[48].predecessorVersionIdentifier==PersistentSchemaV48.versionIdentifier,candidate[48].models.count==162,candidate[48].models.map({ObjectIdentifier($0)})==expectedV49ModelIDs,Array(expectedV49ModelIDs.dropLast(4))==expectedV48ModelIDs,candidate[48].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV50ModelIDs=PersistentSchemaV50.models.map{ObjectIdentifier($0)}
        guard candidate[49] == .v50,candidate[49].versionIdentifier==PersistentSchemaV50.versionIdentifier,candidate[49].compatibilityID==v50CompatibilityID,candidate[49].predecessorVersionIdentifier==PersistentSchemaV49.versionIdentifier,candidate[49].models.count==165,candidate[49].models.map({ObjectIdentifier($0)})==expectedV50ModelIDs,Array(expectedV50ModelIDs.dropLast(3))==expectedV49ModelIDs,candidate[49].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV51ModelIDs=PersistentSchemaV51.models.map{ObjectIdentifier($0)}
        guard candidate[50] == .v51,candidate[50].versionIdentifier==PersistentSchemaV51.versionIdentifier,candidate[50].compatibilityID==v51CompatibilityID,candidate[50].predecessorVersionIdentifier==PersistentSchemaV50.versionIdentifier,candidate[50].models.count==166,candidate[50].models.map({ObjectIdentifier($0)})==expectedV51ModelIDs,Array(expectedV51ModelIDs.dropLast())==expectedV50ModelIDs,candidate[50].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV52ModelIDs=PersistentSchemaV52.models.map{ObjectIdentifier($0)}
        guard candidate[51] == .v52,candidate[51].versionIdentifier==PersistentSchemaV52.versionIdentifier,candidate[51].compatibilityID==v52CompatibilityID,candidate[51].predecessorVersionIdentifier==PersistentSchemaV51.versionIdentifier,candidate[51].models.count==167,candidate[51].models.map({ObjectIdentifier($0)})==expectedV52ModelIDs,Array(expectedV52ModelIDs.dropLast())==expectedV51ModelIDs,candidate[51].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        let expectedV53ModelIDs=PersistentSchemaV53.models.map{ObjectIdentifier($0)}
        guard candidate[52] == .v53,candidate[52].versionIdentifier==PersistentSchemaV53.versionIdentifier,candidate[52].compatibilityID==v53CompatibilityID,candidate[52].predecessorVersionIdentifier==PersistentSchemaV52.versionIdentifier,candidate[52].models.count==168,candidate[52].models.map({ObjectIdentifier($0)})==expectedV53ModelIDs,Array(expectedV53ModelIDs.dropLast())==expectedV52ModelIDs,candidate[52].migrationStage == .custom else{throw PersistentSchemaReleaseRegistryErrorV1.invalidSuccessorRelease}
        guard activeRelease == .v53,activeVersionIdentifier==candidate[52].versionIdentifier,activeCompatibilityID==candidate[52].compatibilityID,
              ...
              PersistentSchemaMigrationPlanV36.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV36.schemas[0])==ObjectIdentifier(PersistentSchemaV36.self),ObjectIdentifier(PersistentSchemaMigrationPlanV36.schemas[1])==ObjectIdentifier(PersistentSchemaV37.self),PersistentSchemaMigrationPlanV36.stages.count==1,
              PersistentSchemaMigrationPlanV37.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV37.schemas[0])==ObjectIdentifier(PersistentSchemaV37.self),ObjectIdentifier(PersistentSchemaMigrationPlanV37.schemas[1])==ObjectIdentifier(PersistentSchemaV38.self),PersistentSchemaMigrationPlanV37.stages.count==1,
              PersistentSchemaMigrationPlanV38.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV38.schemas[0])==ObjectIdentifier(PersistentSchemaV38.self),ObjectIdentifier(PersistentSchemaMigrationPlanV38.schemas[1])==ObjectIdentifier(PersistentSchemaV39.self),PersistentSchemaMigrationPlanV38.stages.count==1,
              PersistentSchemaMigrationPlanV39.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV39.schemas[0])==ObjectIdentifier(PersistentSchemaV39.self),ObjectIdentifier(PersistentSchemaMigrationPlanV39.schemas[1])==ObjectIdentifier(PersistentSchemaV40.self),PersistentSchemaMigrationPlanV39.stages.count==1,
              PersistentSchemaMigrationPlanV40.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV40.schemas[0])==ObjectIdentifier(PersistentSchemaV40.self),ObjectIdentifier(PersistentSchemaMigrationPlanV40.schemas[1])==ObjectIdentifier(PersistentSchemaV41.self),PersistentSchemaMigrationPlanV40.stages.count==1,
              PersistentSchemaMigrationPlanV41.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV41.schemas[0])==ObjectIdentifier(PersistentSchemaV41.self),ObjectIdentifier(PersistentSchemaMigrationPlanV41.schemas[1])==ObjectIdentifier(PersistentSchemaV42.self),PersistentSchemaMigrationPlanV41.stages.count==1,
              PersistentSchemaMigrationPlanV42.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV42.schemas[0])==ObjectIdentifier(PersistentSchemaV42.self),ObjectIdentifier(PersistentSchemaMigrationPlanV42.schemas[1])==ObjectIdentifier(PersistentSchemaV43.self),PersistentSchemaMigrationPlanV42.stages.count==1,
              PersistentSchemaMigrationPlanV43.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV43.schemas[0])==ObjectIdentifier(PersistentSchemaV43.self),ObjectIdentifier(PersistentSchemaMigrationPlanV43.schemas[1])==ObjectIdentifier(PersistentSchemaV44.self),PersistentSchemaMigrationPlanV43.stages.count==1,
              PersistentSchemaMigrationPlanV44.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV44.schemas[0])==ObjectIdentifier(PersistentSchemaV44.self),ObjectIdentifier(PersistentSchemaMigrationPlanV44.schemas[1])==ObjectIdentifier(PersistentSchemaV45.self),PersistentSchemaMigrationPlanV44.stages.count==1,
              PersistentSchemaMigrationPlanV45.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV45.schemas[0])==ObjectIdentifier(PersistentSchemaV45.self),ObjectIdentifier(PersistentSchemaMigrationPlanV45.schemas[1])==ObjectIdentifier(PersistentSchemaV46.self),PersistentSchemaMigrationPlanV45.stages.count==1,
              PersistentSchemaMigrationPlanV46.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV46.schemas[0])==ObjectIdentifier(PersistentSchemaV46.self),ObjectIdentifier(PersistentSchemaMigrationPlanV46.schemas[1])==ObjectIdentifier(PersistentSchemaV47.self),PersistentSchemaMigrationPlanV46.stages.count==1,
              PersistentSchemaMigrationPlanV47.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV47.schemas[0])==ObjectIdentifier(PersistentSchemaV47.self),ObjectIdentifier(PersistentSchemaMigrationPlanV47.schemas[1])==ObjectIdentifier(PersistentSchemaV48.self),PersistentSchemaMigrationPlanV47.stages.count==1,
              PersistentSchemaMigrationPlanV48.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV48.schemas[0])==ObjectIdentifier(PersistentSchemaV48.self),ObjectIdentifier(PersistentSchemaMigrationPlanV48.schemas[1])==ObjectIdentifier(PersistentSchemaV49.self),PersistentSchemaMigrationPlanV48.stages.count==1,
              PersistentSchemaMigrationPlanV49.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV49.schemas[0])==ObjectIdentifier(PersistentSchemaV49.self),ObjectIdentifier(PersistentSchemaMigrationPlanV49.schemas[1])==ObjectIdentifier(PersistentSchemaV50.self),PersistentSchemaMigrationPlanV49.stages.count==1,
              PersistentSchemaMigrationPlanV50.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV50.schemas[0])==ObjectIdentifier(PersistentSchemaV50.self),ObjectIdentifier(PersistentSchemaMigrationPlanV50.schemas[1])==ObjectIdentifier(PersistentSchemaV51.self),PersistentSchemaMigrationPlanV50.stages.count==1,
              PersistentSchemaMigrationPlanV51.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV51.schemas[0])==ObjectIdentifier(PersistentSchemaV51.self),ObjectIdentifier(PersistentSchemaMigrationPlanV51.schemas[1])==ObjectIdentifier(PersistentSchemaV52.self),PersistentSchemaMigrationPlanV51.stages.count==1,
              PersistentSchemaMigrationPlanV52.schemas.count==2,ObjectIdentifier(PersistentSchemaMigrationPlanV52.schemas[0])==ObjectIdentifier(PersistentSchemaV52.self),ObjectIdentifier(PersistentSchemaMigrationPlanV52.schemas[1])==ObjectIdentifier(PersistentSchemaV53.self),PersistentSchemaMigrationPlanV52.stages.count==1 else {
            throw PersistentSchemaReleaseRegistryErrorV1.invalidActiveRelease
        }
    }
...
// C52_BOUNDARY_ANCHOR: persistent-schema-v39
enum C53AssetServiceReliabilityPersistentSchemaBoundaryV1{static let source=39,target=40,addedModels=7,derivedProjectionPersistent=false}
enum C55PartsStockPersistentSchemaBoundaryV1{static let source=40,target=41,addedModels=7,canonicalRowsOnly=true}
