...
struct CurrentPersistentKindLifecycleCatalogV1: Sendable {
    ...
    static func compile(candidateHead: String) throws -> Self {
        ...
        try C08ImportBulkPersistentKindPolicyV1.validateDeclaration()
        try C10EvidenceQualityPersistentKindPolicyV1.validateDeclaration()
        ...
        try C17LightingDayInventoryPersistentKindPolicyV1.validateDeclaration()
        try C18LightingNightWorkflowPersistentKindPolicyV1.validateDeclaration()
        ...
        let descriptorIDs=Set(descriptors.map(\.stableKindID));guard SurveySessionPersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),SurveySessionPersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),AssetLocatorPersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),AssetLocatorPersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),SchedulePersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),SchedulePersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),AssistancePersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),AssistancePersistentKindPolicyV1.nonpersistentKindIDs.isSubset(of:descriptorIDs),AssistancePersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),TemporalEvidencePersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),TemporalEvidencePersistentKindPolicyV1.journalSupportingKindIDs.isSubset(of:descriptorIDs),TemporalEvidencePersistentKindPolicyV1.contentKindIDs.isSubset(of:descriptorIDs),TemporalEvidencePersistentKindPolicyV1.nonpersistentKindIDs.isSubset(of:descriptorIDs),AssetLabelPersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),OperationalContactPersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),C05EvidenceCurationPersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),C05EvidenceCurationPersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),C04ShopReportProfilePersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),C04ShopReportProfilePersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),C05RoundSessionPersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),C05RoundSessionPersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),C08ImportBulkPersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),C08ImportBulkPersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),C10EvidenceQualityPersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),C10EvidenceQualityPersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),C11FastSurveyInboxPersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),C11FastSurveyInboxPersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),C12ReinspectionExceptionPersistentKindCatalogDeclarationV1.durableKindIDs.isSubset(of:descriptorIDs),C12ReinspectionExceptionPersistentKindCatalogDeclarationV1.derivedKindIDs.isSubset(of:descriptorIDs),C13EntityIdentityResolutionPersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),C13EntityIdentityResolutionPersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),C16WorkspaceExperiencePersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),C16WorkspaceExperiencePersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),C17LightingDayInventoryPersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),C17LightingDayInventoryPersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs),C18LightingNightWorkflowPersistentKindPolicyV1.durableKindIDs.isSubset(of:descriptorIDs),C18LightingNightWorkflowPersistentKindPolicyV1.derivedKindIDs.isSubset(of:descriptorIDs)else{throw CurrentPersistentKindLifecycleCatalogFailureV1.incompleteCoverage}
...
/// C12's four SwiftData rows are append-only canonical history. The semantic
/// envelope is derived from those rows and is never a second durable writer.
private enum C12ReinspectionExceptionPersistentKindCatalogDeclarationV1 {
    static let durableKindIDs = Set([
        "PERSISTENT_MODEL:ReinspectionPlanRowV1",
        "PERSISTENT_MODEL:UnchangedAttestationRowV1",
        "PERSISTENT_MODEL:ExceptionQueueAcknowledgementRowV1",
        "PERSISTENT_MODEL:ReinspectionExceptionMutationReceiptRowV1",
    ])
    static let derivedKindIDs = Set(["PROJECTION:StoreSemanticEnvelopeV49"])

    static func validateDeclaration() throws {
        guard durableKindIDs.count == 4,
    ...
    static let plansAttestationsAcknowledgementsAndReceiptsAreCanonicalHistory = true
    static let semanticEnvelopeIsDerived = true
    static let queueItemsAreNotPersistentKinds = true
}
...
private extension CurrentPersistentKindLifecycleCatalogV1 {
    ...
    static let laterTemporalOrigins: [String: TemporalOriginV1] = {
        ...
        let c70=TemporalOriginV1(card:"V23_P03_C32",ordinal:70)
        ...
        let groups: [(TemporalOriginV1, [String])] = [
            ...
            (c70,["PERSISTENT_MODEL:AssistanceAcceptanceReceiptRow","PROJECTION:AssistanceAcceptanceReceiptV1","PROJECTION:AssistanceProposalV1","PROJECTION:AssistanceCapabilityScratchV1","PROJECTION:StoreSemanticEnvelopeV32"]),
            ...
            (TemporalOriginV1(card:"V23_P04_C08",ordinal:96),["PERSISTENT_MODEL:ImportMappingProfileRowV1","PERSISTENT_MODEL:BulkSessionRowV1","PERSISTENT_MODEL:BulkCommitReceiptRowV1","PROJECTION:StoreSemanticEnvelopeV46"]),
            (TemporalOriginV1(card:"V23_P04_C10",ordinal:98),["PERSISTENT_MODEL:EvidenceQualityAssessmentRowV1","PERSISTENT_MODEL:EvidenceQualityRuleSetRowV1","PERSISTENT_MODEL:EvidenceQualityWaiverRowV1","PERSISTENT_MODEL:EvidenceQualityMutationReceiptRowV1","PROJECTION:StoreSemanticEnvelopeV47"]),
            ...
            (TemporalOriginV1(card:"V23_P04_C17",ordinal:105),["PERSISTENT_MODEL:LightingDayInventoryWorkflowRowV1","PROJECTION:StoreSemanticEnvelopeV52"]),
            (TemporalOriginV1(card:"V23_P04_C18",ordinal:106),["PERSISTENT_MODEL:LightingNightWorkflowRowV1","PROJECTION:StoreSemanticEnvelopeV53"]),
        ]
    ...
    static func temporalProvenance(
        ...
        let c32KindIDs=AssistancePersistentKindPolicyV1.durableKindIDs.union(AssistancePersistentKindPolicyV1.nonpersistentKindIDs).union(AssistancePersistentKindPolicyV1.derivedKindIDs).union(["PROJECTION:AssistanceAcceptanceReceiptV1"])
        ...
        let c10EvidenceQualityKindIDs=C10EvidenceQualityPersistentKindPolicyV1.durableKindIDs.union(C10EvidenceQualityPersistentKindPolicyV1.derivedKindIDs)
        ...
        let c17LightingDayInventoryKindIDs=C17LightingDayInventoryPersistentKindPolicyV1.durableKindIDs.union(C17LightingDayInventoryPersistentKindPolicyV1.derivedKindIDs)
        let c18LightingNightWorkflowKindIDs=C18LightingNightWorkflowPersistentKindPolicyV1.durableKindIDs.union(C18LightingNightWorkflowPersistentKindPolicyV1.derivedKindIDs)
        let c17KindIDs = Set([
        ...
        guard kindIDs.count == 453,
              ...
              c32KindIDs.isSubset(of:Set(kindIDs)),
              ...
              c10EvidenceQualityKindIDs.isSubset(of:Set(kindIDs)),
              ...
              c17LightingDayInventoryKindIDs.isSubset(of:Set(kindIDs)),
              c18LightingNightWorkflowKindIDs.isSubset(of:Set(kindIDs)),
