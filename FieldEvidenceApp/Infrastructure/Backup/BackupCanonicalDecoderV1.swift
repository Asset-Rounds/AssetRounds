...
private extension BackupCanonicalDecoderV1 {
    ...
    static func validateGuidedSurveys(_ records:V4BackupRecordsV1)throws{
        ...
        guard (24...C52ServiceRequestBackupDecodingBoundaryV1.recordsSchemaVersion).contains(records.recordsSchemaVersion)
                || records.recordsSchemaVersion == LightingNightWorkflowBackupEnrollmentV1.recordsSchemaVersion else{throw BackupCanonicalDecodingErrorV1.invalidRecords}
    ...
    static func validateSchedules(_ records: V4BackupRecordsV1) throws {
        ...
        guard (26...C52ServiceRequestBackupDecodingBoundaryV1.recordsSchemaVersion).contains(records.recordsSchemaVersion)
    ...
    static func validateSurveyDefinitions(_ records:V4BackupRecordsV1)throws{
        ...
        guard ((23...C52ServiceRequestBackupDecodingBoundaryV1.recordsSchemaVersion).contains(records.recordsSchemaVersion)
                || records.recordsSchemaVersion == LightingNightWorkflowBackupEnrollmentV1.recordsSchemaVersion),let history=records.mutationHistory else{throw BackupCanonicalDecodingErrorV1.invalidRecords}
    ...
    static func validateAccessibleDocumentAssessments(_ records:V4BackupRecordsV1)throws{
        ...
        guard (22...C52ServiceRequestBackupDecodingBoundaryV1.recordsSchemaVersion).contains(records.recordsSchemaVersion)
                || records.recordsSchemaVersion == LightingNightWorkflowBackupEnrollmentV1.recordsSchemaVersion else{throw BackupCanonicalDecodingErrorV1.invalidRecords}
