...
enum C32AssistancePackageValidationV1 {
    ...
    static func validate(_ records: V4BackupRecordsV1, manifest: V4BackupManifestV1) throws {
        ...
        guard manifest.source.persistentSchemaVersion == records.recordsSchemaVersion + 1,
              ...
              (31...LightingNightWorkflowBackupEnrollmentV1.recordsSchemaVersion).contains(records.recordsSchemaVersion),
...
private extension BackupPackageValidatorV1 {
    ...
    func validateObservationAndTime(_ records: V4BackupRecordsV1) throws {
        ...
        guard (4...LightingNightWorkflowBackupEnrollmentV1.recordsSchemaVersion).contains(records.recordsSchemaVersion) else { throw invalid() }
        for record in records.workflowRecords {
    ...
    func validateWorkPackets(
        ...
        guard (14...LightingNightWorkflowBackupEnrollmentV1.recordsSchemaVersion).contains(records.recordsSchemaVersion), manifest.source.persistentSchemaVersion >= 15,
    ...
    func validateFieldDrafts(
        ...
        guard (15...LightingNightWorkflowBackupEnrollmentV1.recordsSchemaVersion).contains(records.recordsSchemaVersion),
              manifest.source.persistentSchemaVersion >= 16,
              let rawWorkspaceID = manifest.source.workspaceID else { throw invalid() }
        let workspaceID = WorkspaceID(rawValue: rawWorkspaceID)
    ...
    func validateFieldReferences(_ records:V4BackupRecordsV1,manifest:V4BackupManifestV1)throws{
        ...
        guard (21...LightingNightWorkflowBackupEnrollmentV1.recordsSchemaVersion).contains(records.recordsSchemaVersion),manifest.source.persistentSchemaVersion==records.recordsSchemaVersion+1,let rawWorkspaceID=manifest.source.workspaceID else{throw invalid()}
        let workspaceID=WorkspaceID(rawValue:rawWorkspaceID)
    ...
    func validateAccessibleDocumentAssessments(_ records:V4BackupRecordsV1,manifest:V4BackupManifestV1,members:ValidatedV4BackupMembersV1)throws{
        ...
        guard (22...LightingNightWorkflowBackupEnrollmentV1.recordsSchemaVersion).contains(records.recordsSchemaVersion),manifest.source.persistentSchemaVersion==records.recordsSchemaVersion+1,let workspaceID=manifest.source.workspaceID else{throw invalid()}
    ...
    func validateSurveyDefinitions(
        ...
        guard (23...LightingNightWorkflowBackupEnrollmentV1.recordsSchemaVersion).contains(records.recordsSchemaVersion),
              manifest.source.persistentSchemaVersion == records.recordsSchemaVersion+1,
    ...
    func validateLighting(
        ...
        guard ((records.recordsSchemaVersion == 30 && manifest.source.persistentSchemaVersion == 31)
              ...
              records.lightingNightWorkflows.allSatisfy({
                  $0.workspaceID == workspaceID
              }) else {
            throw invalid()
        }
        do {
            ...
            guard roundTrip.lighting == records.lighting,
                  ...
                  roundTrip.lightingNightWorkflows
                    == records.lightingNightWorkflows else { throw invalid() }
        } catch {
            throw invalid()
        }
    }
