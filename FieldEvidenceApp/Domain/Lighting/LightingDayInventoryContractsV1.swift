...
struct LightingDayConditionSnapshotV1:Codable,Equatable,Sendable{
    ...
    func validate()throws{
        ...
        try poseEvent?.validate();try facts.forEach{$0.validate()}
