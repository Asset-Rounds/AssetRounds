...
enum C32AssistanceLifecycleBoundary_FieldEvidenceApp_Domain_Pose_PlacementPoseContractsV1_swift {
    ...
    static let deviceProposalIsSeparateFromCanonicalPose = true
...
enum C33TemporalEvidenceConformance_FieldEvidenceApp_Domain_Pose_PlacementPoseContractsV1_swift {
...
enum C45AssetLabelBoundary_Row166 {
...
enum C46OperationalContactConformance_FieldEvidenceApp_Domain_Pose_PlacementPoseContractsV1_swift {
...
enum C52ServiceRequestBoundary_PlacementPoseContractsV1 {
