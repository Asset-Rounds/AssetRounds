...
enum C12AccessibilityIDV1: String, CaseIterable, Sendable { case reinspectionScreen = "v23.p04.c12.reinspection.screen", reinspectionItem = "v23.p04.c12.reinspection.item", reinspectionState = "v23.p04.c12.reinspection.state", queueScreen = "v23.p04.c12.exception-queue.screen", queueItem = "v23.p04.c12.exception-queue.item", queueState = "v23.p04.c12.exception-queue.state" }
