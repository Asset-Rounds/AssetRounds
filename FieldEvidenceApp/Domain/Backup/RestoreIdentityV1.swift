...
extension RestoreIdentityV1 {
    func destinationPartsStockMutationID(for sourceID: MutationIDV1) throws -> MutationIDV1 {
        let digest = CanonicalJSONV1.sha256(Data(
            "parts-stock-restore\u{0}\(sourceID.rawValue.uuidString.lowercased())\u{0}\(targetPointer.workspaceID.uuidString.lowercased())\u{0}\(targetPointer.generationID.uuidString.lowercased())".utf8
        ))
