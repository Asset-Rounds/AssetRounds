...
enum C37PoseIntegration_FieldEvidenceApp_Domain_Workflow_EraseIntentV1_swift {
...
// MARK: - C32 assistance erase intent boundary

enum C32AssistanceLifecycleBoundary_FieldEvidenceApp_Domain_Workflow_EraseIntentV1_swift {
    static let proposalIsPersistent = AssistancePersistenceEnrollmentV1.proposalIsPersistent
    static let rejectedProposalCorpusIsPersistent = AssistancePersistenceEnrollmentV1.rejectedProposalCorpusIsPersistent
    static let durableFamilyCount = AssistancePersistenceEnrollmentV1.durableModelCount
    static let acceptedMutationKind: WorkspaceCommandKindV1 = .applyAssistanceAcceptance
    static let manualFallback: ManualFallbackActionV1 = .typeManually
    static let workspaceEraseRemovesProposalScratchWithoutReceipt = true
...
enum C52ServiceRequestBoundary_EraseIntentV1 {
