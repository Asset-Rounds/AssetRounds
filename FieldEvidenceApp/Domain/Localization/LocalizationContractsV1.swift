...
enum SurveyDefinitionLocalizationKeyV1: String, CaseIterable, Codable, Sendable {
    ...
    case libraryHeading = "survey.template.library.heading"
    case libraryBrowse = "survey.template.library.browse"
    case librarySearch = "survey.template.library.search"
    case libraryFavorites = "survey.template.library.favorites"
    case libraryRecents = "survey.template.library.recents"
    case actionDuplicate = "survey.template.action.duplicate"
    case actionPublish = "survey.template.action.publish"
    case actionRetire = "survey.template.action.retire"
    case actionExport = "survey.template.action.export"
    case actionImportAsDraft = "survey.template.action.import_as_draft"
    ...
    case actionRun = "survey.template.action.run"
    case actionResume = "survey.template.action.resume"
    case actionReview = "survey.template.action.review"
    case actionReport = "survey.template.action.report"
    ...
    case flowClaimBoundary = "survey.template.claim_boundary"
    ...
    var englishDefaultValue: String {
        ...
        case .libraryHeading: return "Survey templates"
        case .libraryBrowse: return "Browse templates"
        case .librarySearch: return "Search templates"
        case .libraryFavorites: return "Favorite templates"
        case .libraryRecents: return "Recent templates"
        case .actionDuplicate: return "Duplicate as draft"
        case .actionPublish: return "Publish template"
        case .actionRetire: return "Retire template"
        case .actionExport: return "Export template"
        case .actionImportAsDraft: return "Import as new draft"
        case .semanticPreview: return "Review template changes"
        case .compatibilityNoChange: return "No semantic change"
        case .compatibilityAdditiveDraftSafe: return "Additive changes can be adopted into a draft"
        case .compatibilityDraftMigrationRequired: return "Draft review is required before adoption"
        case .compatibilityActiveWorkPinned: return "Active survey work remains on its recorded template release"
        case .compatibilityBlocked: return "These template changes cannot be adopted"
        case .actionRun: return "Start survey"
        case .actionResume: return "Resume survey"
        case .actionReview: return "Review recorded survey facts"
        case .actionReport: return "Open survey report"
        case .manualPath: return "Manual entry remains available"
        case .interruption: return "The operation was interrupted; review the recorded state before retrying"
        case .primaryAction: return "Recommended next action"
        case .frozenReport: return "This published survey report remains bound to its recorded release"
        case .reviewConflict: return "Recorded survey facts need explicit conflict review"
        case .promotionConflict: return "Subject promotion needs explicit conflict review"
        case .flowClaimBoundary: return "Survey facts only; no pass or fail result is claimed"
        }
    }
...
enum PlanLocalizationKeyV1: String, CaseIterable, Codable, Sendable {
    ...
    var englishDefaultValue: String {
        ...
        case .offlineNotApplicable: return "A plan is not required for this work item"
...
enum FastSurveyInboxLocalizationKeyV1: String, CaseIterable, Sendable { case heading = "fast.inbox.heading", localOnly = "fast.inbox.local_only", inbox = "fast.inbox.state.inbox", unassigned = "fast.inbox.state.unassigned", collision = "fast.inbox.state.collision", recovery = "fast.inbox.state.recovery", storage = "fast.inbox.state.storage", protected = "fast.inbox.state.protected", review = "fast.inbox.review", promoted = "fast.inbox.promoted", notPromoted = "fast.inbox.not_promoted", capture = "fast.inbox.capture", snippet = "fast.inbox.snippet", previewOnly = "fast.inbox.preview_only", noAcceptance = "fast.inbox.no_acceptance", reducedMotion = "fast.inbox.reduced_motion" }
extension FastSurveyInboxLocalizationKeyV1 { var localizationKey: LocalizationKeyV1 { try! LocalizationKeyV1(rawValue) }; var english: String { switch self { case .heading: return "Quick capture inbox"; case .localOnly: return "This local inbox is awaiting review. Unpromoted items are not complete."; case .inbox: return "Local inbox"; case .unassigned: return "Unassigned local items need review."; case .collision: return "A structured promotion collision needs review."; case .recovery: return "A local recovery step is available."; case .storage: return "Local storage needs attention before more capture."; case .protected: return "Protected local data is unavailable until the device is unlocked."; case .review: return "Review local items"; case .promoted: return "Structured promotion recorded"; case .notPromoted: return "Not promoted; review is still needed"; case .capture: return "Capture locally"; case .snippet: return "Review editable snippets"; case .previewOnly: return "Promotion and snippet insertion are previews until an explicit local action is recorded."; case .noAcceptance: return "This contained screen is not adopted and provides no acceptance credit."; case .reducedMotion: return "Motion is reduced." } } }
enum FastSurveyInboxLocalizationPolicyV1 { static let sourceLocale = "en", adopted = false; static func validate() throws { guard sourceLocale == "en", !adopted, FastSurveyInboxLocalizationKeyV1.allCases.allSatisfy({ !$0.english.isEmpty }) else { throw LocalizationContractFailureV1.invalidValue } } }
enum C12LocalizationKeyV1: String, CaseIterable, Sendable { case reinspectionHeading = "c12.reinspection.heading", reinspectionDisclosure = "c12.reinspection.disclosure", freshEvidence = "c12.reinspection.fresh", unchangedAttestation = "c12.reinspection.unchanged", empty = "c12.state.empty", protected = "c12.state.protected", storage = "c12.state.storage", offline = "c12.state.offline", interrupted = "c12.state.interrupted", error = "c12.state.error", queueHeading = "c12.queue.heading", queueDisclosure = "c12.queue.disclosure", severity = "c12.queue.severity", deduplicated = "c12.queue.deduplicated", preview = "c12.queue.preview", acknowledge = "c12.queue.acknowledge", acknowledged = "c12.queue.acknowledged", notAcknowledged = "c12.queue.not_acknowledged", queueUnavailable = "c12.queue.unavailable", reducedMotion = "c12.reduced_motion" }
