...
enum SchedulePersistentKindPolicyV1{static let durableKindIDs=Set(["PERSISTENT_MODEL:ScheduleDefinitionReleaseRow","PERSISTENT_MODEL:OccurrenceHistoryEventRow"]);static let derivedKindIDs=Set(["PROJECTION:ScheduleDefinitionReleaseV1","PROJECTION:OccurrenceHistoryEventV1","PROJECTION:OccurrenceGenerationPlanV1","PROJECTION:DueQueueProjectionV1","PROJECTION:ReminderProjectionV1","PROJECTION:StoreSemanticEnvelopeV27"]);static func validateDeclaration()throws{guard durableKindIDs.count==2,derivedKindIDs.count==6,durableKindIDs.isDisjoint(with:derivedKindIDs),(durableKindIDs.union(derivedKindIDs)).allSatisfy(PersistentKindLifecycleValidationV1.validKindID)else{throw PersistentKindLifecycleFailureV1.invalidLifecyclePolicy}}}
