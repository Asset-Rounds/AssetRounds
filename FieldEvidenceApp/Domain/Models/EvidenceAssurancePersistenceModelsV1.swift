...
extension AssuranceManifestRow{func exactReference(id:UUID,workspaceID:WorkspaceID,revision:UInt64,sha256:String)throws->AssuranceManifestV1{let v=try value();guard v.manifestID==id,v.workspaceID==workspaceID,v.revision==revision,v.manifestSHA256==sha256 else{throw EvidenceAssuranceFailureV1.invalidValue};return v}}
