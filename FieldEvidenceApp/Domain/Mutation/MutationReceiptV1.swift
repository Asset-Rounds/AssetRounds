...
enum MutationPostImageV1: Codable, Equatable, Sendable {
    ...
    var semanticSHA256: String {
        ...
        case let .evidenceAssociationEvent(_,_,_,value),
             ...
             let .evidenceQuality(_,_,_,_,value), let .fastSurveyInbox(_,_,_,_,value), let .reinspectionException(_,_,_,_,value): return value
    ...
    var revision: UInt64 {
        ...
        case let .evidenceAssociationEvent(_,_,value,_),
             ...
             let .evidenceQuality(_,_,_,value,_), let .fastSurveyInbox(_,_,_,value,_), let .reinspectionException(_,_,_,value,_): return value
