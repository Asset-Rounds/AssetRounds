...
enum C46OperationalContactConformance_FieldEvidenceApp_Application_Plans_PlanRebaseCoordinatorV1_swift {
...
enum C52ServiceRequestBoundary_FieldEvidenceApp_Application_Plans_PlanRebaseCoordinatorV1_swift {
