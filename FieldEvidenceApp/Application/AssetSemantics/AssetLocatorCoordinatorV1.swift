...
struct AssetLocatorCoordinatorV1: Sendable {
    ...
    func resolveSearch(_ input:LocatorResolutionInputV1,workspaceID:WorkspaceID,evaluatedAt:Date)async throws->LocatorResolutionV1{guard input.source == .search else{throw AssetLocatorFailureV1.invalidValue};return try await resolver.resolve(input,workspaceID:workspaceID,evaluatedAt:evaluatedAt)}
...
enum C52ServiceRequestBoundary_FieldEvidenceApp_Application_AssetSemantics_AssetLocatorCoordinatorV1 {
