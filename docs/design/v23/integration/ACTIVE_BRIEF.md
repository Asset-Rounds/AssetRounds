...
Checkpoint only. [CURRENT_INTEGRATION](CURRENT_INTEGRATION.md) controls product scope and gates; [VERIFICATION_DUE](VERIFICATION_DUE.md) retains coverage obligations.
