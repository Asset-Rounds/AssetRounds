...
Original35563517738 at926540c is terminal/sole-collected/root-audited166E4F65: compilePASS,13executed/10Pass/3Fail,0Swift errors/new warning signatures,transportPASS. Build919s/tests522s/job1609s. No active native run/collector. S2 release/rebind now passes; retained old-context read completes, but drain fails. Golden explicitly defers cleanup. Production enable passes; disable throws resourceValueMismatch.

Next batch runtime-926540c/fixture-release removes source-proven fixture retainers through task/function boundaries, preserving explicit old-state retention/drain and all completed-Erase assertions. Default-off DEBUG disable phases localize the remaining production throw; no protection/authorization predicate changes. Source/protocol and one medium complete-boundary/index/commit review precede new native evidence. All52 drafts,882/55, exact13 and D30 budgets remain fixed. Restore7 helper qualification40 hostile/3historical/real readonly entry is independently reviewed but unadopted; its diagnostics remain unexecuted. Handoff2, full interruption cases (including the recorded immediate cleanup-phase mismatch) and missing completion-receipt coverage remain due.
