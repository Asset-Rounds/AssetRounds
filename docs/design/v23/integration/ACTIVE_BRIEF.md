...
Both exactdfb originals are terminal/sole-collected/root-audited: Erase35571609871/0123CA78 compilePASS10/13, Restore35571725811/F1D60E14 compilePASS2/7; transportPASS,0Swift errors/new warning signatures. Build1124s/1094s respectively. No active original/collector. Golden Erase and retained-old-context now pass. One native deferred-presentation failure confirms the reviewed completed-root fixture correction; S2 release/retry invalidIdentity remains unlocalized. Production disable before-auth print is not a proved throw site.

Next Erase13 batch runtime-dfb2759/error-evidence-batch combines the reviewed noncreating completed observers with retained default-off actor phases and caught scalar/kept attachment evidence before cleanup. XCTest restore log5916 has an error-serialization exception, so capture originals before cleanup and preserve every failure. Source/index/commit/native gates due; unchanged13,882/55,D30 and52 drafts. Restore successor is held for complete auxiliary readback correction: actualschema44 vs expected52 omits four snapshots; history counts both3. Its other failures include materialize/recovery and Golden current.wide.accept. Full interruption/handoff/receipt and full-app coverage remain due; no source review grants acceptance.
