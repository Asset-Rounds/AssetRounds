...
Complete C36 lifecycle/codec, child/finalizer recovery, destination/field/scene/resume, live effects, native protection, Work/Round and C55/C57 preservation. Reminder Settings/current-owner/OS journey is source-reviewed44B49A81: unlocked edits, source-bound Round/Work copy, generic AppLock copy, permission/Erase/privacy cleanup and explicit retry. Committed coverage runtime-550ee50/compatibility-enrollment is868/53: the earlier71 reminder/restore members plus7 compatibility methods moved with exact bodies into the selected Settings XCTest owner. All12 prior profiles remain exact. Generator implementation is unchanged. Frozen coverage source132 passes; generator17unchanged+1corrected pass, independent review clear. Combined binding passed at7c0a64c; native checks remain due, with no new native passes.
