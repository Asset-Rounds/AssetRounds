...
| --- | --- | --- |
| Current native blocker | Latest Erase compiles10/13. S2 old read/drain succeeds; post-cleanup guards recreate Erase root. Golden completes cleanup; persisted diagnostic owner/cold-factory expectations need correction. Production disable needs precise direct-stage diagnostics. | Reuse audited5D8955BF and scoped causal reports; preserve Erase13/restore7, all source/index/route/native gates and full interruption/receipt coverage. |
