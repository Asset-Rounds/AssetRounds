...
### Verified S10.6 waiver-aware candidate — 2026-09-10

Original run [34540218053](https://github.com/Asset-Rounds/AssetRounds/actions/runs/34540218053) passed at exact candidate `e28d6827bcf78c26dd6381926aa6aec73d7e9999`: unsigned build, five selected unit methods and one branded UI smoke. Artifact `10177393405` has SHA256 `A3E05448E9B2DAE4D6BEED948DB83F36942AE37F4442466C38D7EF64D4A03CDC`; all 102 artifact files matched their manifest. The selected tests cover actual pending evidence and bounded synthetic ready/receipt cases under the owner waiver; synthetic authenticated inputs do not prove external acceptance. Terminal screenshot SHA256 `D56C831A3F95CC7AC2336A0B5511E1A92C9C87762AFCD9529CC5768FD9CCFCA7` still requires its own genuine human review.

The five frozen store images and the earlier I5 terminal approval retain their exact historical bindings. Name, trademark and URL clearance prerequisites are OWNER_WAIVED under the sealed owner instruction; truthful underlying facts remain NOT_CLEARED/pending. The five unchanged store claims retain their dated source/evidence substantiation. Four accepted predecessor receipts remain; no future Release receipt or phase/main acceptance is asserted. Later owner archive/live/submission facts remain pending and actual release readiness remains false. Complete original commands, observed toolchain, Simulator identity and immutable result hashes are recorded in `unsigned_preparation_ci`.

### Qualified phase evidence and current terminal review — 2026-09-10

The owner approved the displayed exact terminal screenshot from candidate `e28d6827bcf78c26dd6381926aa6aec73d7e9999`, run `34540218053`, artifact `10177393405`, SHA256 `D56C831A3F95CC7AC2336A0B5511E1A92C9C87762AFCD9529CC5768FD9CCFCA7`. Direct review receipt `s10.6-terminal-owner-review-34540218053` is sealed with SHA256 `0306CD7775E0EFA13C8BF7468391BB2543970749CE6E89C546F350BD67B22F9F`. This approval is distinct from the unchanged five store-image approvals and historical I5 image approval.

The seven non-stage documents now declare EVIDENCE_READY with the verified candidate, original F25 evidence, current terminal review, five frozen approved store slots, exact scoped owner waiver, supported five-claim review, source/built privacy and twelve-asset closure, and sealed nonblocking physical deferral. A later K commit will freeze their actual raw blobs; no future K or C is recorded here. Receipt C and phase/exact-main verification remain subsequent gates. Legacy planned/template states and releaseReady=false remain truthful because larger-display upload assets, live release inputs, archive-derived review and submission facts belong to later owner S9.2/S9.3.
