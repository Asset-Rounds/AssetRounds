...
class ActivityCompletedSourceDiagnosticTests(ReplacementPartitionDiagnosticTests):
    ...
    def test_public_choices_and_report_boundary_are_exact(self):
        ...
        for identifier in expected:
            self.assertEqual(options.count(identifier), 1)
        self.assertEqual(CI.ACTIVITY_COMPLETED_SOURCE_PARENT, 'f09909cc0f929b55d0079190294f32f623eae718')
        self.assertEqual(self.source_trees, {'FieldEvidenceApp': 'b0e15d6aff470235bac00758b26f367c7863354d', 'FieldEvidenceAppTests': '6c6bfaf7a3b3ed880390855c289758db0c8ba001', 'FieldEvidenceAppUITests': '978eced2587c6ed6cb280aa6cea7d4e3fa6e4190', 'FieldEvidenceApp.xcodeproj': '4689b1e68b6e5ab1c60c7546fe49a0ff7d1e85d0'})
