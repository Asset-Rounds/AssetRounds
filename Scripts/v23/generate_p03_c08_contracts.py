#!/usr/bin/env python3
"""Generate or check deterministic V23-P03-C08 artifacts."""
...
def main() -> int:
    ...
    try:
        ...
        print(f"V23-P03-C08 generation failed: {error}", file=sys.stderr)
        return 1
    print(f"V23-P03-C08 {'generated' if args.apply else 'verified'} 4 deterministic artifacts")
    return 0
