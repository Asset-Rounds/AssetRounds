#!/usr/bin/env python3
"""Write or check Card32 deterministic package-registry artifacts."""
...
from p03_c01_contracts import ContractError, GENERATED_PATHS, all_outputs
...
def main() -> int:
    ...
    try:
        ...
        print(f"V23-P03-C01 generation failed: {error}", file=sys.stderr)
        return 1
    verb = "wrote" if args.apply else "verified"
    print(f"V23-P03-C01 {verb} {len(GENERATED_PATHS)} deterministic artifacts")
    return 0
