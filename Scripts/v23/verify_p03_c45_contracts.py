...
import p03_c45_contracts as contracts
...
def main() -> int:
    ...
    result = {
        ...
        "fencePathCount": 226, "existingPathCount": 212, "newPathCount": 14,
    ...
    print(json.dumps(result, indent=2, sort_keys=True) if args.json else f"C45 verifier {result['result']}")
