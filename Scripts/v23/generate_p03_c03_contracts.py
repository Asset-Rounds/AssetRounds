#!/usr/bin/env python3
"""Write or check Card 34 deterministic typed-response artifacts."""
...
from p03_c03_contracts import ContractError, GENERATED_PATHS, all_outputs
...
def main() -> int:
    ...
    try:
        ...
        print(f"V23-P03-C03 generation failed: {error}", file=sys.stderr)
        return 1
    verb = "wrote" if args.apply else "verified"
    print(f"V23-P03-C03 {verb} {len(GENERATED_PATHS)} deterministic artifacts")
    return 0
