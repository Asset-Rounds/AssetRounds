...
try:
 ...
 if a.check:
  ...
  print("C13 generator check PASS_STATIC_PROVISIONAL")
 else:
  for k,v in o.items():(c.ROOT/k).parent.mkdir(parents=True,exist_ok=True);(c.ROOT/k).write_bytes(v)
  print("C13 generator apply PASS_STATIC_PROVISIONAL generated=4")
except Exception as e:print("C13 generator FAIL_STATIC:"+str(e),file=sys.stderr);raise SystemExit(1)
