"""Generate the five deterministic C34 tooling receipts."""
...
def main() -> None:
    ...
    if args.check:
        if drift:
            raise SystemExit("C34 artifact drift: " + ",".join(drift))
        print("C34 generator check PASS_STATIC_PROVISIONAL generated=5")
        return

    _write_atomically(documents)
    print("C34 generator apply PASS_STATIC_PROVISIONAL generated=5")
