#!/usr/bin/env python3
"""Generate or check the four deterministic V23-P03-C10 artifacts."""
...
def main() -> int:
    ...
    try:
        ...
        print(f"V23-P03-C10 generation failed: {error}", file=sys.stderr)
        return 1
    print(f"V23-P03-C10 {'check' if args.check else 'generation'} PASS ({len(outputs)} artifacts)")
    return 0
