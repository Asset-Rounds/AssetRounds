#!/usr/bin/env python3
"""Apply or check deterministic Card 27 contract artifacts."""
...
from p02_c07_contracts import GENERATED_PATHS, all_outputs
...
def main() -> int:
    ...
    for relative in GENERATED_PATHS:
        ...
        if args.apply:
            ...
            return 1
    print(f"Card27 {'generated' if args.apply else 'verified'} {len(GENERATED_PATHS)} deterministic artifacts")
    return 0
