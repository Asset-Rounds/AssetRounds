#!/usr/bin/env python3
"""Generate or check canonical V23-P01-C04 static contract artifacts."""
...
from p01_c04_contracts import ContractError, all_outputs
...
def main() -> int:
    ...
    try:
        ...
        print(f"V23-P01-C04 generation failed: {error}", file=sys.stderr)
        return 1
    stale = []
