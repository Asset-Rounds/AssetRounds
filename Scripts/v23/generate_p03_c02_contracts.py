#!/usr/bin/env python3
"""Write or check Card 33 deterministic package-release artifacts."""
...
from p03_c02_contracts import ContractError, GENERATED_PATHS, all_outputs
...
def main() -> int:
    ...
    try:
        ...
        print(f"V23-P03-C02 generation failed: {error}", file=sys.stderr)
        return 1
    verb = "wrote" if args.apply else "verified"
    print(f"V23-P03-C02 {verb} {len(GENERATED_PATHS)} deterministic artifacts")
    return 0
