#!/usr/bin/env python3
"""Apply or check deterministic Card 30 tooling artifacts."""
...
from p02_c10_contracts import GENERATED_PATHS, all_outputs
...
def main() -> int:
    ...
    try:
        ...
        print(f"Card30 generation failed: {error}", file=sys.stderr)
        return 1
    mode = "generated" if args.apply else "verified"
    print(f"Card30 {mode} {len(GENERATED_PATHS)} deterministic artifacts")
    return 0
