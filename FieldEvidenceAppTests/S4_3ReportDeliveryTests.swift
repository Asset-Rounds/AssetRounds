...
private enum C47ActivityContractCompatibility_FieldEvidenceAppTests_S4_3ReportDeliveryTests_swift {
...
private final class C47ActivityContractCompatibility_FieldEvidenceAppTests_S4_3ReportDeliveryTests_swift_Tests: XCTestCase {
    func testC47S43ReportDeliveryTestsOwnerCompatibilityIsTyped() {
        ...
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_S4_3ReportDeliveryTests_swift.installationAndPunchReceiptsRemainIndependent)
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_S4_3ReportDeliveryTests_swift.noPlanFallbackIsExplicit)
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_S4_3ReportDeliveryTests_swift.surveyDefinitionOwnershipIsPreserved)
