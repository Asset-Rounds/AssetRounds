...
final class S6_2BackupExportTests: XCTestCase {
    ...
    func testCanonicalFixturesAndExportedBundleTypeDeclaration() throws {
        ...
        XCTAssertEqual(bytes.components(separatedBy: "INFOPLIST_KEY_UTExportedTypeDeclarations =").count - 1, 2)
        XCTAssertEqual(bytes.components(separatedBy: "com.palatis3.fieldrecordbackup").count - 1, 2)
