...
private enum C52ServiceRequestBoundary_V9_29WorkPacketManifestTests {
...
final class V9_29WorkPacketManifestTests: XCTestCase {
    ...
    func testV23P03C15MutationTransitionTableAndConcurrencyIdentity() throws {
        ...
        XCTAssertEqual(try successorClaimMutation.postImage.predecessorIdentity?.id, fixture.claim.claimID)
        XCTAssertEqual(try successorLeaseMutation.postImage.predecessorIdentity?.id, fixture.lease.leaseID)
