...
private enum C47ActivityContractCompatibility_FieldEvidenceAppTests_V9_12WorkflowGraphTests_swift {
...
private final class C47ActivityContractCompatibility_FieldEvidenceAppTests_V9_12WorkflowGraphTests_swift_Tests: XCTestCase {
    func testC47V912WorkflowGraphTestsOwnerCompatibilityIsTyped() {
        ...
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_V9_12WorkflowGraphTests_swift.installationAndPunchReceiptsRemainIndependent)
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_V9_12WorkflowGraphTests_swift.noPlanFallbackIsExplicit)
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_V9_12WorkflowGraphTests_swift.surveyDefinitionOwnershipIsPreserved)
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_V9_12WorkflowGraphTests_swift.legacyInspectionTruthIsNotRewritten)
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_V9_12WorkflowGraphTests_swift.threeReceiptIsolationIsRequired)
