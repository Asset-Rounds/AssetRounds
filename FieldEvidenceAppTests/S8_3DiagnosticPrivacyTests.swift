...
private enum C53AssetServiceReliabilityBoundary_S8_3DiagnosticPrivacyTests {
...
private final class C32AssistanceAnchorS83DiagnosticPrivacy: XCTestCase {
    func testC32S83DiagnosticPrivacyCompatibilityKeepsProposalAtExplicitReviewBoundary() throws {
        let proposal = try C32AssistanceTestSupport.ownerProposal(
            entityKind: .asset,
            fieldID: "diagnostics.bounded-counts-only",
            value: .text("private proposal payload")
        )
...
private enum C47ActivityContractCompatibility_FieldEvidenceAppTests_S8_3DiagnosticPrivacyTests_swift {
...
private final class C47ActivityContractCompatibility_FieldEvidenceAppTests_S8_3DiagnosticPrivacyTests_swift_Tests: XCTestCase {
    func testC47S83DiagnosticPrivacyTestsOwnerCompatibilityIsTyped() {
        ...
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_S8_3DiagnosticPrivacyTests_swift.installationAndPunchReceiptsRemainIndependent)
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_S8_3DiagnosticPrivacyTests_swift.noPlanFallbackIsExplicit)
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_S8_3DiagnosticPrivacyTests_swift.surveyDefinitionOwnershipIsPreserved)
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_S8_3DiagnosticPrivacyTests_swift.legacyInspectionTruthIsNotRewritten)
        XCTAssertTrue(C47ActivityContractCompatibility_FieldEvidenceAppTests_S8_3DiagnosticPrivacyTests_swift.threeReceiptIsolationIsRequired)
