...
class S10BrandMigrationRouteUITestCase: XCTestCase {
   ...
   private func acceptImportedPhoto(
    ...
    private func diagnoseReduceMotionWorkSavingContrast(
        ...
        func diagnosticElementObject(_ element: XCUIElement) -> [String: Any] {
            let value: Any
        ...
        printJSONLine(
            prefix: "S10_4_REDUCE_MOTION_WORK_SAVING_CONTEXT_DIAGNOSTIC",
            object: context
        )
        ...
        try app.performAccessibilityAudit(for: .contrast) { issue in
            ...
            self.printJSONLine(
                prefix: "S10_4_REDUCE_MOTION_WORK_SAVING_ISSUE_DIAGNOSTIC",
                object: diagnostic
            )
            return true
        }
